...
impl super::CasperClient {
    ...
    fn new_transfer_transaction(
        ...
        Transaction::V1(
            transaction_builder
                .with_ttl(self.configuration.ttl())
                .with_chain_name(self.configuration.chain_name())
                .with_pricing_mode(Self::payment_limited_pricing_mode(amount.as_u64()))
                .with_secret_key(self.secret_key())
                .with_timestamp(timestamp)
                .build()
    ...
    fn new_call_transaction(
        ...
        let transaction_v1 = transaction_builder
            .with_ttl(self.configuration.ttl())
            .with_chain_name(self.configuration.chain_name())
            .with_pricing_mode(Self::payment_limited_pricing_mode(
                call_def.amount().as_u64() + self.gas.as_u64()
            ))
            .with_secret_key(self.secret_key())
            .with_timestamp(timestamp)
    ...
    fn pricing_mode(&self) -> PricingMode {
        Self::payment_limited_pricing_mode(self.gas.as_u64())
    }

    fn payment_limited_pricing_mode(payment_amount: u64) -> PricingMode {
    ...
    fn gas_price_tolerance() -> u8 {
        env::var("CASPER_GAS_PRICE_TOLERANCE")
            .ok()
